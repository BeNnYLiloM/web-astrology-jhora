...
function fixedMaxMoon(meanLongitude, apogeeLongitude) {
...
for (const testCase of CASES) {
  ...
  const moon = fixedMaxMoon(diagnostic.moon.meanLongitude, diagnostic.moon.apogeeLongitude);
  const sunManda = normalize180(diagnostic.sun.trueLongitude - diagnostic.sun.meanLongitude);
  const corrected = normalize360(moon + sunManda / 27.0);
